...
import {
  ...
  AlertCircle, Bone, Moon, Syringe, PawPrint,
} from 'lucide-react'
import type { LucideIcon } from 'lucide-react'
import './Dashboard.css'

type NavKey = 'home' | 'location' | 'health' | 'vet' | 'settings'
...
const STATS: { Icon: LucideIcon; value: string; unit: string; label: string; highlight?: boolean }[] = [
  { Icon: Route,       value: '4.2',  unit: ' km',  label: 'Distance today'    },
  { Icon: Thermometer, value: '38.2', unit: '°C',   label: 'Body temperature'  },
  { Icon: Activity,    value: '78',   unit: ' bpm', label: 'Heart rate'        },
  { Icon: BatteryFull, value: '98',   unit: '%',    label: 'Collar battery', highlight: true },
]
        ...
        <aside className="sidebar">
          ...
          <nav className="sidebar-nav">
            {NAV_ITEMS.map(({ key, Icon, label }) => (
              ...
              >
                <Icon size={18} strokeWidth={activeNav === key ? 2.5 : 2} className="ni" />
                {label}
              </div>
            ))}
          </nav>
          ...
          <div className="sidebar-bottom">
            <div className="snav-item" onClick={onSignOut}>
              <LogOut size={18} strokeWidth={2} className="ni" />
              Sign out
            </div>
          </div>
        </aside>
        ...
        <main className="dash-main">
          ...
          <div className="emotion-strip">
            ...
            <div className="emotion-text">
              ...
              <span>HR 78 bpm · Temp 38.2°C · BP 118/78 — all within normal range</span>
            </div>
          ...
          <div className="dash-cols">
            <div className="sec-card">
              <div className="sec-card-title">
                <MapPin size={13} strokeWidth={2.5} /> Live location + path trace
              </div>
              <div className="map-box">
                <div className="map-grid-bg" />
                <div className="danger-zone" />
                <div className="safe-zone" />
                <div className="paw-trail" style={{ left: '30%', top: '68%' }}>🐾</div>
                <div className="paw-trail" style={{ left: '37%', top: '59%' }}>🐾</div>
                <div className="paw-trail" style={{ left: '44%', top: '50%' }}>🐾</div>
                <div className="paw-trail" style={{ left: '50%', top: '43%' }}>🐾</div>
                <div className="map-pin" />
                <div className="map-legend">
                  <div className="ml"><span className="ml-dot" style={{ background: 'rgba(29,158,117,.7)' }} />Safe zone</div>
                  <div className="ml"><span className="ml-dot" style={{ background: 'rgba(226,75,74,.6)' }} />Danger zone</div>
                  <div className="ml"><span className="ml-dot" style={{ background: '#2E86C1' }} />Live</div>
                </div>
              </div>
            </div>
            ...
            <div className="sec-card">
              <div className="sec-card-title">
                <Activity size={13} strokeWidth={2.5} /> Vitals
              </div>
              <div className="vitals-grid">
                <div className="v-card">
                  <div className="v-label"><Heart size={11} strokeWidth={2.5} /> Heartbeat</div>
                  <div><span className="v-value">78</span><span className="v-unit"> bpm</span></div>
          ...
          <div className="dash-cols">
            <div className="sec-card">
              <div className="sec-card-title">
                <TrendingUp size={13} strokeWidth={2.5} /> Temperature trend
              </div>
              ...
              <div className="temp-times">
                {TEMP_TIMES.map(t => <span key={t}>{t}</span>)}
              </div>
            </div>

            <div className="sec-card">
              <div className="sec-card-title">
                <Bell size={13} strokeWidth={2.5} /> Recent events
              </div>
              <div className="ev-list">
                {EVENTS.map(({ bg, Icon, title, sub, time }, i) => (
                  <div className="ev-item" key={i}>
                    <div className="ev-dot" style={{ background: bg }}>
          ...
          <div className="dash-col-full">
            <div className="sec-card">
              ...
              <div className="vet-card vet-red">
                ...
                <div className="vet-info">
                  <p>Health alert</p>
                  <span>Temp elevated · book a checkup soon</span>
                </div>
          ...
          <div className="dash-col-full">
            <div className="sec-card">
              <div className="sec-card-title">
                <Settings size={13} strokeWidth={2.5} /> Quick stats
              </div>
